...
async function TeamPage({ params }: { params: Promise<{ teamsId: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-2 sm:p-8">
      <div className="max-w-6xl w-full my-2 sm:my-0">
        {/* Team Dashboard Card */}
        <div className="bg-white rounded-lg sm:rounded-2xl border border-black sm:border-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-3.5 sm:p-6">
          {/* Header */}
